...
class MuezzinSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardGradient = isDark
        ...
        : [Colors.white, Colors.white]; // في الفاتح خلفية بيضاء
    ...
    return Scaffold(
        backgroundColor: bgColor, // خلفية ديناميكية
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('اختر القسم', style: GoogleFonts.cairo(color: subTextColor, fontSize: 16)),
                        ...
                        return TweenAnimationBuilder(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(colors: isSheikhs
                                    ? [_gold.withOpacity(0.2), _gold.withOpacity(0.05)]
                                    : cardGradient ), // يستخدم التدرج الديناميكي
                                borderRadius: BorderRadius.circular(24),
                                border: Border.all(
                                  color: isSheikhs ? _gold.withOpacity(0.5) : borderColor,
                                  width: isSheikhs ? 2 : 1,
                                ),
                                boxShadow: [
                                  BoxShadow(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: cat.imageAsset != null
                                              ? AssetImage(cat.imageAsset!) as ImageProvider
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(cat.name, style: GoogleFonts.amiri(fontSize: 22, color: textColor, fontWeight: FontWeight.bold)),
                                                const SizedBox(height: 4),
                                                Text(cat.description, style: GoogleFonts.cairo(color: subTextColor, fontSize: 14)),
                                              ],
                                            ),
                                          ),
                                          if (isSheikhs)
                                            Container(
                                              ...
                                              child: Text('مشايخ', style: GoogleFonts.cairo(color: _gold, fontSize: 12, fontWeight: FontWeight.bold)),
                                            ),
                                        ],
                                      ),
                                    ),
                      ...
                      // الـ RadioMiniPlayer سيتأثر تلقائياً إذا قمت بتعديل ألوانه داخل الكلاس الخاص به بنفس الطريقة
