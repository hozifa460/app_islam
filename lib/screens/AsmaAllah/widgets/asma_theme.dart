...
class AsmaTheme {
  ...
  // ==============================
  // ًںژ­ AppBar Gradients
  // ==============================
  List<Color> get circleAppBarGradient => isDark
      ? [const Color(0xFF1A2540).withValues(alpha: 0.95), const Color(0xFF0F1628).withValues(alpha: 0.85)]
      : [const Color(0xFFFFFDF5).withValues(alpha: 0.95), const Color(0xFFFFF8E1).withValues(alpha: 0.85)];
  ...
  List<Color> get cardGradient => isDark
      ? [const Color(0xFF1A2438).withValues(alpha: 0.9), const Color(0xFF0F1628).withValues(alpha: 0.9)]
      : [Colors.white, const Color(0xFFFFF8E8)];

  Color get cardBorder => gold.withValues(alpha: isDark ? 0.3 : 0.25);
  ...
  List<BoxShadow> get cardShadow => [
    BoxShadow(
      color: isDark ? Colors.black.withValues(alpha: 0.3) : gold.withValues(alpha: 0.1),
      blurRadius: 20,
