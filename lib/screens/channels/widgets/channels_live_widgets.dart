...
// ══════════════════════════════════════════════════════════════
//  ✨ نقطة بث متحركة مع أمواج (Ripple Waves)
// ══════════════════════════════════════════════════════════════
        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: widget.color.withOpacity(0.4 * (1 - _wave1Anim.value)),
                  width: 1.5,
                ),
              ),
            ),
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(
                  color: widget.color.withOpacity(0.3 * (1 - _wave2Anim.value)),
                  width: 1,
                ),
              ),
            ),
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: widget.color.withOpacity(_pulseAnim.value),
                boxShadow: [
                  BoxShadow(
                    color: widget.color.withOpacity(_pulseAnim.value * 0.5),
...
// ══════════════════════════════════════════════════════════════
//  ✨ شارة LIVE محسّنة مع Shimmer + Glow
// ══════════════════════════════════════════════════════════════
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, child) => Container(
        ...
        decoration: BoxDecoration(
          color: Colors.red.withOpacity(_glowAnim.value),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: Colors.red.withOpacity(0.3 + _glowAnim.value),
            width: 1.5,
          ),
          boxShadow: [
            BoxShadow(
              color: Colors.red.withOpacity(_glowAnim.value * 0.6),
              blurRadius: 12,
              spreadRadius: 1,
            ),
          ],
...
// نقطة بسيطة بدون أمواج (للأماكن الصغيرة)
...
// ══════════════════════════════════════════════════════════════
//  ✨ زر البث المباشر المحسّن مع أمواج وتوهج
// ══════════════════════════════════════════════════════════════
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Colors.red.withOpacity(widget.isDark ? 0.2 : 0.12),
                  const Color(0xFFFF4444).withOpacity(widget.isDark ? 0.15 : 0.08),
                  Colors.red.withOpacity(widget.isDark ? 0.2 : 0.12),
                ],
              ),
              ...
              border: Border.all(
                color: Colors.red.withOpacity(0.35 + _glowAnim.value * 0.3),
                width: 1.5,
              ),
              boxShadow: [
                BoxShadow(
                  color: Colors.red.withOpacity(_glowAnim.value * 0.5),
                  blurRadius: 16,
                  spreadRadius: 1,
                ),
                BoxShadow(
                  color: Colors.red.withOpacity(_glowAnim.value * 0.2),
                  blurRadius: 30,
                  spreadRadius: 3,
                ),
              ],
...
// ══════════════════════════════════════════════════════════════
//  ✨ مؤشر "مباشر الآن" يظهر على بطاقة الشيخ
// ══════════════════════════════════════════════════════════════
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              Colors.red.withOpacity(_anim.value * 0.8),
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.red.withOpacity(_anim.value * 0.3),
              blurRadius: 8,
            ),
          ],
        ),
